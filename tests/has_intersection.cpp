...
#include "cg/operations/has_intersection.h"

TEST(has_intersection, tests)
{
    ...
    EXPECT_TRUE(cg::has_intersection(a1, b1));

    EXPECT_FALSE(cg::has_intersection(a2, b2));

    EXPECT_TRUE(cg::has_intersection(a3, b3));

    EXPECT_TRUE(cg::has_intersection(a4, b4));

    EXPECT_FALSE(cg::has_intersection(a5, b5));
}
